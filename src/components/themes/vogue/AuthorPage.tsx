  ...
  return (
    <ThemeLayout HeaderComponent={PublicHeader} FooterComponent={PublicFooter}>
      <div className="text-center mb-12">
        <h1 className="text-4xl font-black font-headline tracking-widest uppercase">Author</h1>
        <p className="text-sm text-muted-foreground mt-2">Showing posts by author ID: {authorId}</p>
      </div>
